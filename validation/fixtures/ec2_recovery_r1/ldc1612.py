    ...
    def cmd_LDC_CALIBRATE(self, gcmd):
        ...
        if fault_seq_start:
            raise self.printer.command_error(
                'LDC1612 drive-current calibration blocked: an I2C transport '
                'fault was already observed in this Klipper session; '
                'FIRMWARE_RESTART is required before calibration')
        is_in_progress = True
