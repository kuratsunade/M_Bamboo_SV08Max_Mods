...
## 文档结构对齐，2026 年 9 月 11 日

恢复 main README 的项目概览、功能 ownership、安装、总览 FAQ 及文档导航结构。Technical FAQ 沿用基线源码问题顺序，整合当前操作恢复与测量证据边界；详细测试留在专门文档。候选安装和恢复限制继续在适用位置保留。不改变运行时、安装器、阈值或功能范围，不新增实机验收声明。
